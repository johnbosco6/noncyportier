                        ...
                        {activeTab === 'home' && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <button className="flex flex-col items-center justify-center gap-2 p-4 glass rounded-2xl hover:bg-amber-500/20 hover:border-amber-500/50 transition-all duration-300 group">
